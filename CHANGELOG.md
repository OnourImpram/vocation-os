...
7. Added the deterministic VocationOS desktop icon set, a committed Rust dependency lock, an exact Rust `1.97.1` toolchain contract, and locked native CI resolution.
