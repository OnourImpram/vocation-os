...
export const SCHEMA_NAMES = [
  ...
  "trusted-collector",
  "assurance-case",
  "assurance-document-ast",
  "credential-mapping",
  "credential-passport",
  "discovery-dedupe-result",
  "discovery-egress-manifest",
  "discovery-liveness-assessment",
  "discovery-network-access-grant",
  "discovery-opportunity-truth-record",
  "discovery-signed-network-access-grant",
  "discovery-source-observation",
  "intelligence-assertion",
  "intelligence-ats-document",
  "intelligence-campaign",
  "intelligence-career-twin",
  "intelligence-interview",
  "intelligence-network",
  "intelligence-offer",
  "intelligence-outcome-experiment",
